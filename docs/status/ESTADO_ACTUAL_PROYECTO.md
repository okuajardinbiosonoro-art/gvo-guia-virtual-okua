...
Estado: carga inicial animada V5 implementada y pendiente de revisión visual.

## Implementado

- App Vite + React + TypeScript.
- Router con rutas placeholder del recorrido.
- Pantalla de carga inicial animada V5 en `/` y `/carga`.
...
- Próximo trabajo funcional: revisión visual de la animación V5 de carga inicial y refinamiento si el usuario lo solicita.
...
## Ticket 001 / 001B / 001C / 001D / 001E / 001F: Carga inicial

- Estado: ANIMACION_V5_IMPLEMENTADA / EN_REVISION_VISUAL.
...
- Pantalla de carga inicial animada V5: integrada en `/` y `/carga` para revisión visual.
...
- Rama funcional actual: feature/001F-carga-inicial-layout-halo-centrado-v5.

## Matriz de estados por pantalla

| Pantalla                  | Estado de madurez                              | Bloqueo / avance permitido                     |
| ------------------------- | ---------------------------------------------- | ---------------------------------------------- |
| Carga inicial pre-portada | ANIMACION_V5_IMPLEMENTADA / EN_REVISION_VISUAL | Revisión visual del usuario                    |
...
Revisar visualmente la carga inicial animada V5 en navegador móvil. Si el usuario aprueba, documentar cierre; si pide ajustes, crear una iteración acotada de refinamiento de carga inicial.
