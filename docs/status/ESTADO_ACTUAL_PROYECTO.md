...
Estado: carga inicial animada V4 implementada y pendiente de revisión visual.

## Implementado

- App Vite + React + TypeScript.
- Router con rutas placeholder del recorrido.
- Pantalla de carga inicial animada V4 en `/` y `/carga`.
...
- Próximo trabajo funcional: revisión visual de la animación V4 de carga inicial y refinamiento si el usuario lo solicita.
...
## Ticket 001 / 001B / 001C / 001D / 001E: Carga inicial

- Estado: ANIMACION_V4_IMPLEMENTADA / EN_REVISION_VISUAL.
...
- Pantalla de carga inicial animada V4: integrada en `/` y `/carga` para revisión visual.
...
- Rama funcional actual: feature/001E-carga-inicial-calibracion-agua-layout-v4.

## Matriz de estados por pantalla

| Pantalla                  | Estado de madurez                              | Bloqueo / avance permitido                     |
| ------------------------- | ---------------------------------------------- | ---------------------------------------------- |
| Carga inicial pre-portada | ANIMACION_V4_IMPLEMENTADA / EN_REVISION_VISUAL | Revisión visual del usuario                    |
...
Revisar visualmente la carga inicial animada V4 en navegador móvil. Si el usuario aprueba, documentar cierre; si pide ajustes, crear una iteración acotada de refinamiento de carga inicial.
