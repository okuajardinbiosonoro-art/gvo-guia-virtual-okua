...
Estación III está `CERRADA_APROBADA_FINAL` (`HUMAN_APPROVED`) en `/estacion/3`. Mundo IV conserva una base técnica preexistente, pero no está aprobado ni fue iniciado por el cierre `GVO-017K-R1`.
