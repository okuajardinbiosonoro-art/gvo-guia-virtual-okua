...
Repositorio con carga inicial animada V5. La carga inicial pre-portada está disponible en `/` y `/carga`, usa assets runtime locales normalizados y queda pendiente de revisión visual del usuario. No está cerrada como pantalla final aprobada.
...
- Carga inicial: ANIMACION_V5_IMPLEMENTADA / EN_REVISION_VISUAL
